...
public class SceneControlleEditor : Editor<SceneController>
{
    ...
    private void OnSceneGUI()
    {
        ...
        if (targetObject.defaultStartPoint.Slider2D(out Vector3 newPoint)){
            Undo.RecordObject(target, "Change defaultStartPoint");
            targetObject.defaultStartPoint = newPoint;
        }
